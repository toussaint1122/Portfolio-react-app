...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full overflow-hidden ring-2 ring-primary/60 shrink-0">
              <img
                src="/profile.jpg"
                alt="MUGISHA Toussaint"
      ...
      <section
        id="about"
        className="max-w-6xl mx-auto px-6 pt-32 pb-24 grid md:grid-cols-2 gap-12 items-center"
      >
        <div>
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-4">
            I build products that make people's lives easier. My focus is on
            web applications and developer tools.
          </p>

          <p className="text-muted-foreground leading-relaxed mb-8">
            I'm passionate about sharing knowledge and helping others grow in
            coding. On my YouTube channel, I teach programming step by step —
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="w-full border border-primary/40 rounded-xl p-5 bg-card">
            ...
            {[
              ...
              <p
                key={fact}
                className="text-muted-foreground text-sm py-1.5 border-b border-border/50 last:border-0"
              >
                {fact}
              </p>
            ))}
            ...
            {[
              ...
              >
                ...
                {items.map((item) => (
                  <p
                    key={item}
                    className="text-muted-foreground text-sm py-1 hover:text-primary cursor-default transition-colors"
                  >
                    {item}
                  </p>
                ))}
          ...
          <div className="space-y-4">
            {[
              ...
              >
                ...
                <p className="text-muted-foreground text-sm sm:max-w-sm">
                  {desc}
                </p>
              </div>
            ))}
            ...
            {[
              {
                Icon: Mail,
                label: "EMAIL",
                value: "ishimwedidierk@gmail.com",
                href: "mailto:ishimwedidierk@gmail.com",
              },
              {
                Icon: Phone,
                label: "PHONE",
                value: "+250 781 998 106",
                href: "tel:+250781998106",
              },
              {
                Icon: Github,
                label: "GITHUB",
                value: "toussaint1122",
                href: "https://github.com/toussaint1122",
              },
